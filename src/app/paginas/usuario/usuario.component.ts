...
import { UsuarioDataSource, UsuarioItem } from './usuario-datasource';
import {
  MatSnackBar,
...
@Component({
  ...
  export class UsuarioComponent implements AfterViewInit, OnInit {
    ...
    displayedColumns = ['id', 'usuario', 'nombre', 'apellido', 'rol', 'mail', 'accion'];
